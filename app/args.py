...
def parse_arguments():
    ...
    parser.add_argument("--min-salary", type=int, help="Filter jobs by minimum salary.")
    parser.add_argument("--sort-by", type=str, choices=["date"], help="Sort jobs by date posted.")
